...
extension LocationIpService on AMapWebService {
  ...
  Future<LocationIpResponse> locationIP({String? ip}) async {
    ...
    return LocationIpResponse.fromJson(jsonDecode(response.body));
  }
}